...
int main(int argc, char const *argv[])
{
	...
	printf("To Convert Input To AlternateCase Enter 2\n");
    printf("---------------------------------------------------------\n");
	...
	//get acknowledgement
	char first[100];
	char errormsg[100] = "Sorry, already got 5 clients!";
	recv(sfd, &first, 100, 0);
	printf("%s\n", first);
	if (strcmp(errormsg, first) == 0)	//quit if cant join
	 	return 0;
