...
//Ports
#define VJA_PORT 10000
#define HYD_PORT 10001
#define DEL_PORT 10002
#define STATION_PORT 10003
#define PF1_PORT 10004
#define PF2_PORT 10005
#define PF3_PORT 10006
...
struct sockaddr_in createSocketDG(int *sfd, int port)
{
    ...
    //set reusable
    int true = 1;
    setsockopt((*sfd), SOL_SOCKET, SO_REUSEADDR | SO_REUSEPORT, &true, sizeof(true));
